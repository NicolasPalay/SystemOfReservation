 ...
 */
final class Version20230814065401 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE booking (id INT AUTO_INCREMENT NOT NULL, client_id INT DEFAULT NULL, hairdresser_id INT DEFAULT NULL, speciality_id INT DEFAULT NULL, date DATETIME NOT NULL, INDEX IDX_E00CEDDE19EB6921 (client_id), INDEX IDX_E00CEDDE696F8EFF (hairdresser_id), INDEX IDX_E00CEDDE3B5A08D7 (speciality_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE speciality (id INT AUTO_INCREMENT NOT NULL, picture_id INT DEFAULT NULL, name_speciality VARCHAR(100) NOT NULL, duration INT NOT NULL, content LONGTEXT DEFAULT NULL, rate DOUBLE PRECISION NOT NULL, UNIQUE INDEX UNIQ_F3D7A08EEE45BDBF (picture_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
